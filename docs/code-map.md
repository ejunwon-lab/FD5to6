...
- `components/system/SettingsPage.tsx` — Settings(단축키 S): localStorage `desk_settings_v1`(`lib/settings.ts` — holdingsViewMode·holdingsInitialVisible[0=전체]·cardFoldDefault[auto/folded/unfolded]) — DashboardHoldings가 마운트 시 소비
