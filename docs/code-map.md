...
- `components/dashboard/` — `DashboardPage`, `KpiStrip`, `MarketIndices`, `EquityChart`(범위 버튼은 달력일 날짜 산술로 필터 — slice 아님), `ActivityFeed`, `DashboardHoldings`, `HoldingsStatusStrip`, `HoldingsTable`, `Indicators`
