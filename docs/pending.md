...
- **🟡 데스크 iPad 가로모드 개선 트랙 (2026-08-06 시작)** — 1차 사이드바 재편 완료(4섹션 Portfolio/Activity/Market/System·`tradelog`→`activity` 개명·Dividends 메뉴 제거·터치 타깃 40px·단축키 힌트 pointer-fine 한정). **잔여**: ①배포 후 iPad 실기기 확인(4섹션·힌트 부재·오탭 없음) ②다음 개선 대상 사용자와 논의. 세션: `docs/sessions/2026-08-06-데스크-iPad-사이드바재편.md`
