...
- **🟡 web-desk 모바일 반응형 — Dashboard부터 진행 중 (2026-07-23 착수, 구 "모바일 컴팩트 모드" 승계)** — 사용자 결정: 별도 모바일 페이지 대신 데스크 반응형(iPhone 17 Pro 기준). Dashboard 탭 우선 + 홀딩스 리스트 길이 개선. 이후 Today→Analysis 순 확장.
