...
- **🟡 web-desk 모바일 반응형 — Dashboard 1단계 완료, Today→Analysis 잔여 (2026-07-23, 구 "모바일 컴팩트 모드" 승계)** — 사용자 결정: 별도 모바일 페이지 대신 데스크 반응형(iPhone 17 Pro 기준). 완료: MobileTabBar(하단 탭 6)·100dvh 셸·홀딩스 상위 9 접기·필터바 2행화. **잔여**: ①아이폰 실기기 확인(하단 탭·접기 토글) ②Today·Analysis 탭 모바일 다듬기 ③사용 피드백 반영.
