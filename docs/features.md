...
- 매도 복기 **전용 탭**(`SoldTrackerPage`, 분석 오른쪽 "복기") — 정렬(최근/차이/실현/경과/종목명·방향 토글) + 요약 + 목록 (2026-07-15). 대시보드 카드는 전용 탭 신설로 제거(2026-07-16)
- 계좌 유형별: 일반 투자 **증권사 계좌 단위 분리**(삼성 종합/삼성 ISA, 미래는 단일계좌라 증권사명만) (2026-07-16)
