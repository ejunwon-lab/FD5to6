                ...
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={priceData} margin={{ top: 8, right: 8, bottom: 4, left: 0 }}>
                    ...
                    <YAxis
                      ...
                      tick={{ fontSize: 10, fill: 'rgb(var(--c-ink-faint))', fontFamily: 'var(--font-body)' }}
                      tickLine={false} axisLine={{ stroke: 'rgb(var(--c-line))' }} width={82}
                    ...
                    />
                    {avgPrice != null && (
                      <ReferenceLine y={avgPrice} stroke="rgb(var(--c-cyan))" strokeDasharray="4 3" strokeOpacity={0.6} />
                    )}
                    <Line type="monotone" dataKey="price" stroke="rgb(var(--c-amber))" strokeWidth={1.5} dot={false} />
                    {txMarkers.map((m, i) => (
                      <ReferenceDot
                        key={`${m.date}-${i}`}
                        x={m.date} y={m.price}
