...
// Preview·테스트용 고정 샘플 데이터.
// 실제 API 응답 구조와 동일하게 유지할 것 (PortfolioModels.swift 변경 시 여기도 갱신).
enum MockData {
    ...
    static let indicatorsResponse = IndicatorsResponse(
        ...
        indicators: [
            ...
            ReferenceIndicator(key: "NDX",    name: "나스닥100",category: "미국지수", value: 18_143.2, change: 185.6,  changePct: 1.03),
            ReferenceIndicator(key: "DJI",    name: "다우존스", category: "미국지수", value: 39_512.8, change: -88.4,  changePct: -0.22),
            ReferenceIndicator(key: "VIX",    name: "VIX",     category: "변동성",   value: 18.32,   change: -1.24,  changePct: -6.34),
            ReferenceIndicator(key: "USD_KRW",name: "달러/원",  category: "환율",    value: 1_348.5,  change: -5.3,   changePct: -0.39),
            ReferenceIndicator(key: "GOLD",   name: "금",       category: "원자재",   value: 2_312.4,  change: 18.6,   changePct: 0.81),
            ReferenceIndicator(key: "WTI",    name: "WTI유가",  category: "원자재",   value: 78.42,   change: 0.94,   changePct: 1.21),
        ]
    )
    ...
    static let trendHistoryResponse = TrendHistoryResponse(
        ...
        entries: [
            ...
            TrendEntry(date: "2026-01-13", totalProfit: 620_000),
            TrendEntry(date: "2026-01-20", totalProfit: 580_000),
            TrendEntry(date: "2026-01-27", totalProfit: 810_000),
            TrendEntry(date: "2026-02-03", totalProfit: 950_000),
            TrendEntry(date: "2026-02-10", totalProfit: 1_120_000),
            TrendEntry(date: "2026-02-17", totalProfit: 980_000),
            TrendEntry(date: "2026-02-24", totalProfit: 1_340_000),
            TrendEntry(date: "2026-03-03", totalProfit: 1_180_000),
            TrendEntry(date: "2026-03-10", totalProfit: 1_420_000),
            TrendEntry(date: "2026-03-17", totalProfit: 1_550_000),
            TrendEntry(date: "2026-03-24", totalProfit: 1_310_000),
            TrendEntry(date: "2026-03-31", totalProfit: 1_680_000),
            TrendEntry(date: "2026-04-07", totalProfit: 1_420_000),
            TrendEntry(date: "2026-04-14", totalProfit: 1_750_000),
            TrendEntry(date: "2026-04-21", totalProfit: 1_820_000),
            TrendEntry(date: "2026-04-28", totalProfit: 1_650_000),
