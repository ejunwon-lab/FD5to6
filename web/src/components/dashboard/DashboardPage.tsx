...
export function DashboardPage() {
  ...
  return (
    <div className="h-[100dvh] overflow-hidden">
      ...
      >
        {/* ── Page 1: 대시보드 ── */}
        <div className="min-w-full h-full overflow-y-auto no-scrollbar bg-[rgb(var(--page-bg))]">
          <div className="pb-32">
            {/* Header */}
            <div
              className="px-4 pt-12 pb-3"
              style={{
                background: 'linear-gradient(135deg, #405AE6 0%, #7340D9 100%)',
              }}
            >
            ...
            {!isLoading && (
              <div
                className="flex flex-col items-center mt-6 gap-1 text-gray-300 cursor-pointer"
                onClick={() => setPage(1)}
              >
                <span className="text-xs">아래로 — 기간별 수익</span>
        ...
        {/* ── Page 2: 수익 히스토리 ── */}
        <div className="min-w-full h-full overflow-y-auto no-scrollbar relative">
          <button
            className="absolute top-4 left-4 z-10 text-accent text-sm font-medium"
            onClick={() => setPage(0)}
          >
            ↑ 대시보드
          </button>
