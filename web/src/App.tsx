  ...
  return (
    <div className="h-[100dvh] flex flex-col items-center justify-center bg-[rgb(var(--page-bg))] px-8">
      ...
      {isLoading ? (
        ...
        <button
          onClick={signIn}
          className="flex items-center gap-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl px-6 py-4 shadow-md active:scale-95 transition-transform"
        >
